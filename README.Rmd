...
Upper prediction bands offer flexible FDP control: one can increase the rejection threshold (thus increasing the size of the discovery set) and check the corresponding upper prediction bound to gauge the size of the FDP in a post hoc manner. See the application section below for an example.
